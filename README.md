...
### RBAC Controls (5)
- ✅ `ocp4-cis-rbac-least-privilege` (HIGH)
- ✅ `ocp4-cis-rbac-limit-cluster-admin` (MEDIUM)
- ✅ `ocp4-cis-rbac-limit-secrets-access` (MEDIUM)
- ✅ `ocp4-cis-rbac-pod-creation-access` (MEDIUM)
- ✅ `ocp4-cis-rbac-wildcard-use` (MEDIUM)

### SCC Controls (9)
- ✅ `ocp4-cis-scc-limit-privileged-containers` (MEDIUM)
- ✅ `ocp4-cis-scc-limit-root-containers` (MEDIUM)
- ✅ `ocp4-cis-scc-limit-privilege-escalation` (MEDIUM)
- ✅ `ocp4-cis-scc-drop-container-capabilities` (MEDIUM)
- ✅ `ocp4-cis-scc-limit-net-raw-capability` (MEDIUM)
- ✅ `ocp4-cis-scc-limit-ipc-namespace` (MEDIUM)
- ✅ `ocp4-cis-scc-limit-network-namespace` (MEDIUM)
- ✅ `ocp4-cis-scc-limit-process-id-namespace` (MEDIUM)
- ✅ `ocp4-cis-general-apply-scc` (MEDIUM)

### General Controls (4)
- ✅ `ocp4-cis-general-default-namespace-use` (MEDIUM)
- ✅ `ocp4-cis-general-default-seccomp-profile` (MEDIUM)
- ✅ `ocp4-cis-general-namespaces-in-use` (MEDIUM)

### Secrets Controls (2)
- ✅ `ocp4-cis-secrets-consider-external-storage` (MEDIUM)
- ✅ `ocp4-cis-secrets-no-environment-variables` (MEDIUM)

### Service Account Controls (2)
- ✅ `ocp4-cis-accounts-restrict-service-account-tokens` (MEDIUM)
- ✅ `ocp4-cis-accounts-unique-service-account` (MEDIUM)
...
Control: ocp4-cis-rbac-limit-cluster-admin
─────────────────────────────────────────────────────────────
